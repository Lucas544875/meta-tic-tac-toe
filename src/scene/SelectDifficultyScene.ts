...
export class SelectDifficultyScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(this.game.canvas.width/2, this.game.canvas.height/2 + 180, 'EASY', {fontSize: 35, fontFamily: "Exo", color: "#31254b"}).setOrigin(0.5);

    this.addMode(0, 0, 512*0.8, 200*0.8, "hard");
    this.add.text(this.game.canvas.width/2, this.game.canvas.height/2+4 , 'HARD', {fontSize: 35, fontFamily: "Exo", color: "#31254b"}).setOrigin(0.5);

    this.addMode(0, -170, 512*0.8, 210*0.8, "veryhard");
    this.add.text(this.game.canvas.width/2, this.game.canvas.height/2 - 162, 'VERYHARD', {fontSize: 35, fontFamily: "Exo", color: "#31254b"}).setOrigin(0.5);
